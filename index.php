...
class TerminalPHP{
    ...
    public function runCommand($command){
        ...
        if (array_search($cmd, $this->getLocalCommands()) !== false){
            ...
            return 'Terminal: command not found: '.$cmd;
    }
  ...
  <head>
    ...
    <style>
      ...
      *{ font-family: var(--font);}
      body{ background-size: cover; margin: 0; padding: 0; background-attachment: fixed; overflow: hidden; }
      a{ color: #29a9ff; }
      terminal{ display: block; height: 80vh; width: 80vw; position: relative; margin: 7rem auto; background: inherit; overflow: hidden; }
      terminal::before,
      ...
      terminal content{ position: absolute; top: 30px; left: 1.5%; width: 98%; height: 92%; z-index: 1; overflow-x: hidden; overflow-y: auto; color: #ececec; font-size: var(--font-size); }
